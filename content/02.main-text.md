...
It is challenging to measure which hidden layer sizes tended to perform relatively well or poorly, since different genes may have different baseline performance AUPR values and overall classifier effect sizes.
