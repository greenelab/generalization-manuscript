...
Our data suggest that this conclusion holds in both linear models (LASSO logistic regression) and non-linear deep neural networks with hidden layer size as the regularization parameter of interest.
