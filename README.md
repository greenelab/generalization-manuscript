...
[![HTML Manuscript](https://img.shields.io/badge/manuscript-HTML-blue.svg)](https://greenelab.github.io/generalization-manuscript/)
[![PDF Manuscript](https://img.shields.io/badge/manuscript-PDF-blue.svg)](https://greenelab.github.io/generalization-manuscript/manuscript.pdf)
[![GitHub Actions Status](https://github.com/greenelab/generalization-manuscript/workflows/Manubot/badge.svg)](https://github.com/greenelab/generalization-manuscript/actions)
...
When a commit to the `main` branch occurs (for example, when a pull request is merged), CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/greenelab/generalization-manuscript/tree/gh-pages) and [`output`](https://github.com/greenelab/generalization-manuscript/tree/output) branches.
...
Please open [an issue](https://github.com/greenelab/generalization-manuscript/issues) for any question related to licensing.
